/*=========================================================================
  ...
  Module:    vtkImageCompositeDataProbeFilter.h
...
=========================================================================*/
// .NAME vtkImageCompositeDataProbeFilter - subclass of vtkProbeFilter which supports
// composite datasets in the input.
// .SECTION Description
// vtkImageCompositeDataProbeFilter supports probing into multi-group datasets.
...
#ifndef __vtkImageCompositeDataProbeFilter_h
#define __vtkImageCompositeDataProbeFilter_h

#include "vtkFiltersCoreModule.h" // For export macro
#include "vtkImageProbeFilter.h"

class vtkCompositeDataSet;
class VTKFILTERSCORE_EXPORT vtkImageCompositeDataProbeFilter : public vtkImageProbeFilter
{
public:
  static vtkImageCompositeDataProbeFilter* New();
  vtkTypeMacro(vtkImageCompositeDataProbeFilter, vtkImageProbeFilter);
...
//BTX
protected:
  vtkImageCompositeDataProbeFilter();
  ~vtkImageCompositeDataProbeFilter();
...
private:
  vtkImageCompositeDataProbeFilter(const vtkImageCompositeDataProbeFilter&); // Not implemented.
  void operator=(const vtkImageCompositeDataProbeFilter&); // Not implemented.
//ETX
};
