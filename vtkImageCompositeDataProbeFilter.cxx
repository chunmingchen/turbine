/*=========================================================================
  ...
  Module:    vtkImageCompositeDataProbeFilter.cxx
...
vtkStandardNewMacro(vtkImageCompositeDataProbeFilter);
//----------------------------------------------------------------------------
vtkImageCompositeDataProbeFilter::vtkImageCompositeDataProbeFilter()
{
...
//----------------------------------------------------------------------------
int vtkImageCompositeDataProbeFilter::FillInputPortInformation(
...
//----------------------------------------------------------------------------
vtkExecutive* vtkImageCompositeDataProbeFilter::CreateDefaultExecutive()
{
  return vtkCompositeDataPipeline::New();
}

//----------------------------------------------------------------------------
int vtkImageCompositeDataProbeFilter::RequestData(
  ...
  vtkInformationVector *outputVector)
{
  ...
  if (!sourceDS && !sourceComposite)
    {
    vtkErrorMacro("vtkDataSet10 or vtkCompositeDataSet is expected as the input "
      "on port 1");
    return 0;
    }
...
//----------------------------------------------------------------------------
void vtkImageCompositeDataProbeFilter::InitializeForProbing(vtkDataSet *input, vtkDataSet *output)
{
  ...
  for (int cc=0; cc < outPD->GetNumberOfArrays(); cc++)
    ...
    if (da)
      ...
      //if (da->IsA("vtkDoubleArray") || da->IsA("vtkFloatArray")) //changed by Jimmy here!!
      //  {
...
//----------------------------------------------------------------------------
int vtkImageCompositeDataProbeFilter::BuildFieldList(vtkCompositeDataSet* source)
{
...
//----------------------------------------------------------------------------
void vtkImageCompositeDataProbeFilter::PrintSelf(ostream& os, vtkIndent indent)
{
